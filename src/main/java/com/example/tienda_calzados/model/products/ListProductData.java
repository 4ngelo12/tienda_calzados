...
public record ListProductData(Long id, String code, String name, String description, String image, Integer size,
                              String brand, BigDecimal purchase_price, BigDecimal sale_price, Integer stock,
                              Category category) {
    public ListProductData(Products data) {
        this(data.getId(), data.getCode(), data.getName(), data.getDescription(), data.getImage(), data.getSize(),
